        ...
        <View style={styles.container}>
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                <View style={styles.profileHeader}>
                    ...
                    <Text style={styles.profileSubtitle}>Teacher • {adminProfile.school}</Text>
                </View>

                <Text style={styles.sectionTitle}>Account Details</Text>
                <View style={styles.infoCard}>
                    <InfoRow icon={<User size={18} color={Theme.colors.textPrimary} />} label="Name" value={adminProfile.name} />
                    <InfoRow icon={<GraduationCap size={18} color={Theme.colors.textPrimary} />} label="Role" value={'Teacher'} />
